...
const proxynya =  question(`- Use proxy? y/n : `);
proxynya == 'y' ? question(`- ex: http://myusername:mypassword@727.38.288.2:8080`) : '';
proxynya == 'y' ? question(`- ex: http://727.38.288.2:8080`) : '';
const proxy = proxynya == 'y' ? question(`- Proxy : `) : '';
...
(async () => {
    try {
        ...
        proxynya == 'y' ? ig.state.proxyUrl = proxy : null;
